...
public enum Setting {
    ...
    SHOW_PING_ON_SCOREBOARD(
            ChatColor.AQUA + "Show Pings on Scoreboard",
            ImmutableList.of(
                    ChatColor.GREEN+ "If enabled, you will see pings on scoreboard",

                    ChatColor.GREEN+ "Disable to hide pings on scoreboard."
            ),
            Material.ARROW,
            ChatColor.YELLOW + "Pings on scoreboard are shown",
            ChatColor.YELLOW + "Pings on scoreboard are hidden",
            false,
            null
    );
