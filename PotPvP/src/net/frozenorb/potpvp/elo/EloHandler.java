...
import net.frozenorb.potpvp.elo.command.EloSetCommands;
...
public final class EloHandler {
    ...
    public EloHandler() {
        ...
        ShivaLib.getInstance().getHoncho().registerCommand(new EloSetCommands.EloSetSolo());
        ShivaLib.getInstance().getHoncho().registerCommand(new EloSetCommands.EloSetTeam());
        ShivaLib.getInstance().getHoncho().registerCommand(new MongoEloRepository.RecalcGlobalElo());
