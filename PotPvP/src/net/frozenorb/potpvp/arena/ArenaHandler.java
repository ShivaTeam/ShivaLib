...
import net.frozenorb.potpvp.arena.command.*;
import net.frozenorb.potpvp.arena.listener.ArenaBlockChangeListener;
...
public final class ArenaHandler {
    ...
    public ArenaHandler() {
        ...
        Bukkit.getPluginManager().registerEvents(new ArenaBlockChangeListener(), PotPvPSI.getInstance());

        ShivaLib.getInstance().getHoncho().registerCommand(new ArenaCreateSchematicCommand.ArenaCreateSchematic());
        ShivaLib.getInstance().getHoncho().registerCommand(new ArenaFreeCommand.ArenaFree());
        ShivaLib.getInstance().getHoncho().registerCommand(new ArenaListArenasCommand.ArenaListArenas());
        ShivaLib.getInstance().getHoncho().registerCommand(new ArenaListSchematicsCommand.ArenaListSchematics());
        ShivaLib.getInstance().getHoncho().registerCommand(new ArenaRepasteSchematicCommand.ArenaRepasteShematic());
        ShivaLib.getInstance().getHoncho().registerCommand(new ArenaScaleCommand.ArenaScale());
    ...
    public Optional<Arena> allocateUnusedArena(Predicate<ArenaSchematic> acceptableSchematicPredicate) {
        ...
        Arena selected = acceptableArenas.get(ShivaLib.RANDOM.nextInt(acceptableArenas.size()));
