...
public final class Party {
     ...
     * New UUID = new Party
     */
    @Getter private final UUID partyId = new UUID(ShivaLib.RANDOM.nextLong(), ShivaLib.RANDOM.nextLong());
    ...
    public void leave(Player player) {
        ...
        if (leader.equals(player.getUniqueId())) {
            ...
            Player newLeader = Bukkit.getPlayer(membersArray[ShivaLib.RANDOM.nextInt(membersArray.length)]);
