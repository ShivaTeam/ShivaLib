...
public final class PartyInviteCommand {
    ...
    @CommandMeta(label = {"party invite", "p invite", "t invite", "team invite", "invite", "inv", "party inv", "p inv", "t inv", "team invite", "f invite", "f inv"}, permission = "")
    public static class PartyInvite{
        public void execute(Player sender, Player player){
            partyInvite(sender, player);
        }
    }
    public static void partyInvite(Player sender, Player target) {
        if(target == null){
    ...
    @CommandMeta(label = {"party invite **", "p invite **", "t invite **", "team invite **", "invite **", "inv **", "party inv **", "p inv **", "t inv **", "team invite **", "f invite **", "f inv **"}, permission = "op")
    public static class PartyInviteAll{
        public void execute(Player sender){
            partyInviteAll(sender);
        }
    }
