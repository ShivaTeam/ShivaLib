...
public final class PartyHelpCommand {
    ...
    @CommandMeta(label = {"party", "p", "t", "team", "f", "party help", "p help", "t help", "team help", "f help"}, permission = "")
    public static class PartyHelp{
        public void execute(Player sender){
            partyhelp(sender);
        }
    }
    public static void partyhelp(Player sender) {
