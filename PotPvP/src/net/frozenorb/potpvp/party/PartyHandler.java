...
import net.frozenorb.potpvp.party.command.*;
...
public final class PartyHandler {
    ...
    public PartyHandler() {
        ...
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyCreateCommand.PartyCreate());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyDisbandCommand.PartyDisband());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyFfaCommand.PartyFfa());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyFfaCommand.PartyDevFfa());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyHelpCommand.PartyHelp());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyInfoCommand.PartyInfo());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyInviteCommand.PartyInvite());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyInviteCommand.PartyInviteAll());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyJoinCommand.PartyJoin());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyKickCommand.PlayerKick());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyLeaderCommand.PartyLeader());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyLeaveCommand.PartyLeave());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyLockCommand.PartyLock());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyOpenCommand.PartyOpen());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyPasswordCommand.PartyPassword());
        ShivaLib.getInstance().getHoncho().registerCommand(new PartyTeamSplitCommand.PartyTeamSplit());
    }
