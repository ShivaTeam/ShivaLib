...
import net.frozenorb.potpvp.match.command.MapCommand;
import net.frozenorb.potpvp.match.command.SpectateCommand;
import net.frozenorb.potpvp.match.command.ToggleMatchCommands;
...
public final class MatchHandler {
    ...
    public MatchHandler() {
        ...
        ShivaLib.getInstance().getHoncho().registerCommand(new LeaveCommand.Leave());
        ShivaLib.getInstance().getHoncho().registerCommand(new MapCommand.Map());
        ShivaLib.getInstance().getHoncho().registerCommand(new SpectateCommand.Spectate());
        ShivaLib.getInstance().getHoncho().registerCommand(new ToggleMatchCommands.ToggleMatchesUnranked());
        ShivaLib.getInstance().getHoncho().registerCommand(new ToggleMatchCommands.ToggleMatchesRanked());
